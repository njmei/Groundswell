classdef Viewtroller < handle
  ...
  properties
    ...
    border_roi_h
    label_roi_h
    %roi_struct;  % has fields roi_ids, border_h, label_h
...
%                floor(image_area_height/n_row));
      ...
      self.figure_h = ...
        figure('Position',posit,...
               'Name','Roving',...
               'NumberTitle','off',...
               'KeyPressFcn',@(src,event)(self.handle_key()),...
        ...
        uicontrol('Parent',self.figure_h,...
                  ...
                  'Position',...
                    [figure_left_pad_size+mode_button_width+...
                     ...
                     vcr_button_width,...
                     vcr_button_height],...
                   'Callback',@(src,event)(self.change_frame(1)));
        ...
        uicontrol('Parent',self.figure_h,...
                  ...
                  'Position',...
                    [figure_left_pad_size+mode_button_width+...
                     ...
                     vcr_button_height],...
                   'Callback', ...
                     @(src,event)(self.change_frame(self.frame_index-1)));
      self.stop_button_h = ...
        uicontrol('Parent',self.figure_h,...
                  'Style','pushbutton',...
                  'String','O',...
        ...
        uicontrol('Parent',self.figure_h,...
                  ...
                  'Position',...
                    [figure_left_pad_size+mode_button_width+...
                     ...
                     vcr_button_height],...
                   'Callback', ...
                     @(src,event)(self.change_frame(self.model.n_frame)));
      ...
      self.frame_index_edit_h = ...
        uicontrol('Parent',self.figure_h,...
                  ...
                  'Callback',@(src,event)(self.handle_frame_index_edit()));
      ...
      self.open_rois_menu_h= ...
        uimenu(self.file_menu_h,...
               ...
               'enable','off',...
               'Separator','on',...
               'Callback',@(~,~)(self.load_rois_from_file()));
      ...
      self.export_to_tcs_menu_h= ...
        uimenu(self.file_menu_h,...
               ...
               'enable','off',...
               'Callback',@(~,~)(self.export_to_tcs_file()),...
               'Enable','off');
      self.quit_menu_h= ...
        uimenu(self.file_menu_h,...
               'Label','Quit',...
...
%       n_roi=length(self.roi_struct);
%       roi_list=struct('border',cell(n_roi,1), ...
%                       'label',cell(n_roi,1) );
%       for i=1:n_roi
%         bh=self.roi_struct(i).border_h;
%         roi_list(i).border=[get(bh,'xdata') ; ...
%                             get(bh,'ydata')];
%         lh=self.roi_struct(i).label_h;
%         roi_list(i).label=get(lh,'string');                  
%       end
%     end
